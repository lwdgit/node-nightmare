...
Nightmare.prototype.showWindow = function(done) {
  this.child.call('showWindow', done);  
  return this;
};

Nightmare.prototype.hideWindow = function(done) {
  this.child.call('hideWindow', done);
  return this;
};
